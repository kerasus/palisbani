  ...
  data () {
    return {
      ...
      inputs: [
        ...
        { type: 'inputEditor', name: 'syllabus', responseKey: 'syllabus', label: 'مقرری', col: 'col-md-12' },
        { type: 'inputEditor', name: 'syllabus', responseKey: 'syllabus', label: 'تکلیف', col: 'col-md-12' }
      ]
    }
  },
  created () {
